...
public class RoomManager : MonoBehaviourPunCallbacks
{
    ...
    public void OnEnterRoomButtonClicked_Outdoor()
    {
        ...
        PhotonNetwork.JoinRandomRoom(expectedCustomRoomProperties,0); // Bug fix: Missing this third line. (Not loading Outdoor map)
    }
        ...
        foreach (RoomInfo room in roomList)
            {
                ...
                else if (room.Name.Contains(MultiplayerVRConstants.MAP_TYPE_VALUE_SCHOOL)) // Bug fix: Use constant value instead of mapType variable
                {
